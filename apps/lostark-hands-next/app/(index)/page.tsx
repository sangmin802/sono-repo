...
import NotificationButton from '@/app/(index)/_components/notification-button';

import ServerWrapper from '../server-wrapper';
import DailyContent from './_components/daily-content';
import DailyContentSkeleton from './_components/daily-content/skeleton';
import Event from './_components/event';
import EventSkeleton from './_components/event/skeleton';
import Notice from './_components/notice';
import NoticeSkeleton from './_components/notice/skeleton';
import ProcyonCompass from './_components/procyon-compass';
import ProcyonCompassSkeleton from './_components/procyon-compass/skeleton';
